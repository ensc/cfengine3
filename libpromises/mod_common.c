...
const ConstraintSyntax CFS_CONTROLBODY[SERVER_CONTROL_MAX + 1] =
{
    ...
    ConstraintSyntaxNewInt("port", "1,65535", "Default port for cfengine server. Default value: 5309", SYNTAX_STATUS_NORMAL),
...
const ConstraintSyntax CFH_CONTROLBODY[] =  /* enum cfh_control */
{
    ...
    ConstraintSyntaxNewInt("port", "1,65535", "Default port for contacting hub nodes. Default value: 5309", SYNTAX_STATUS_NORMAL),
